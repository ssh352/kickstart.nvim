...
require('lazy').setup({
    ...
    -- repo, not just copy pasted the init.lua. If you want these files, they
    -- are in the repository, so you can just download them and place them in
